...
<body>
    <div class = "search-box">
        <form name = "SearchGrade" method = "GET">
        <h4>Enter your LRN Number: </h4><input class = "LRN" type = "text" name = "num" placeholder = "Student LRN">
    ...
    <div class = "Result-box">
        ...
        <?php }
                ...
                echo "<div style = ' text-align: center; font-size:25px;'><br><strong>Please enter your correct LRN Number or Contact your adviser</strong></div>";
            }
        ?>
